...
`ls` - show the files and folders in the working directory. It's probably short for "list," but if you like acronyms, think: "list stuff!"

`cd` - move to a directory, whose name you'll type immediately after this command and a space. `cd Desktop` will move to the "Desktop" folder. Some special cases:
